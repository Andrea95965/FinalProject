var mainState = {
    ...
    create: function() {
        ...
        this.fireball11= this.game.add.sprite (800,0,'fireball');
        this.fireball12= this.game.add.sprite (900,0,'fireball');
        this.fireball13= this.game.add.sprite (1100,0,'fireball');
        this.fireball14= this.game.add.sprite (700,0,'fireball');
        this.fireball15= this.game.add.sprite (790,0,'fireball');
        ...
        this.fireball20= this.game.add.sprite (1400,0,'fireball');
        this.fireball21= this.game.add.sprite (700,0,'fireball');
        this.fireball22= this.game.add.sprite (500,0,'fireball');
        this.fireball23= this.game.add.sprite (806,0,'fireball');
        this.fireball24= this.game.add.sprite (1000,0,'fireball');
        this.fireball25= this.game.add.sprite (980,0,'fireball');
        this.fireball26= this.game.add.sprite (600,0,'fireball');
        this.fireball27= this.game.add.sprite (4080,0,'fireball');
        this.fireball28= this.game.add.sprite (1043,0,'fireball');
        this.fireball29= this.game.add.sprite (543,0,'fireball');
        ...
        this.fireball3.body.gravity.y= 7;
        this.fireball4.body.gravity.y= 6;
        this.fireball5.body.gravity.y= 15;
        this.fireball6.body.gravity.y= 8;
        this.fireball7.body.gravity.y= 18;
        this.fireball8.body.gravity.y= 3;
        ...
        this.fireball23.body.gravity.y=70;
        this.fireball24.body.gravity.y=12;
        this.fireball25.body.gravity.y=17;
        this.fireball26.body.gravity.y=11;
        this.fireball27.body.gravity.y=12;
        this.fireball28.body.gravity.y=20;
        this.fireball29.body.gravity.y=11;
        this.fireball30.body.gravity.y=12;
