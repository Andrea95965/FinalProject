var mainState = {
    ...
    create: function() {
        ...
        this.fireball = this.game.add.sprite(678, 0, 'fireball');
        ...
        this.fireball24= this.game.add.sprite (2370,0,'fireball');
        this.fireball25= this.game.add.sprite (764,0,'fireball');
        this.fireball26= this.game.add.sprite (979,0,'fireball');
        this.fireball27= this.game.add.sprite (2300,0,'fireball');
        ...
        this.fireball28= this.game.add.sprite (500,0,'fireball');
        ...
        this.fireball9.body.gravity.y=80;
        this.fireball10.body.gravity.y=100;
        ...
        this.fireball7.body.gravity.y= 150;
        this.fireball8.body.gravity.y=16;
        this.fireball9.body.gravity.y=19;
        this.fireball10.body.gravity.y=10;
        this.fireball11.body.gravity.y=20;
        this.fireball12.body.gravity.y=15;
        this.fireball13.body.gravity.y=90;
        this.fireball14.body.gravity.y=100;
        this.fireball15.body.gravity.y=70;
        this.fireball16.body.gravity.y=120;
        this.fireball17.body.gravity.y=10;
        this.fireball18.body.gravity.y=18;
        this.fireball19.body.gravity.y=127;
        this.fireball20.body.gravity.y=20;
        this.fireball21.body.gravity.y=110;
        this.fireball22.body.gravity.y=90;
        this.fireball23.body.gravity.y=80;
        this.fireball24.body.gravity.y=90;
        this.fireball25.body.gravity.y=76;
        this.fireball26.body.gravity.y=45;
        this.fireball27.body.gravity.y=50;
        this.fireball28.body.gravity.y=15;
