...
playGame.prototype = {
     ...
     create: function(){  
        this.game.stage.backgroundColor = '#87CEEB';       
          game.add.text(game.width / 2, 50, "Select your dino", {font: "18px Arial", fill: "#ffffff"}).anchor.set(0.5);
          ...
          for(var i = 0; i < colors.length; i++){
               var dino = game.add.image(game.width / 2 + i * 90, game.height / 2, "dino");
               dino.anchor.set(0.5);
               this.scrollingMap.addChild(dino)
          }
